...
function Main() {
  ...
  return (
    <>
    {/* 다크모드 버튼  */}
      <div className="w-full h-[780px] bg-white text-slate-900 pt-10 dark:bg-gray-600">
         {/*   bg-[#F8FAFB] */}
                    ...
                    <div className="lg:flex lg:items-center lg:flex-row lg:gap-12">
                        ...
                        <div className="txt-box ">
                            <div className="absolute top-10 right-10 ">
                              <p className="txt-box text-[2rem] md:text-[4rem] lg:text-[6rem]" style={{transform:`translate(${position}px)`}}>Hong YoonJung</p>
                            </div>
                            <div className="absolute bottom-20 left-14">
                               <p className="txt-box text-[2rem] md:text-[4rem] lg:text-[6rem]" style={{transform:`translate(${-position}px)`}}>FrontEnd Developer</p>
                            </div>
                        </div>
                        </div>
                    </div>             
