...
function Skill() {
  ...
  return (
    <>
      <div className="w-full h-auto bg-white py-20 dark:bg-slate-800 dark:text-white">
        <div className="max-w-7xl mx-auto">
          <p className="w-[91%] text-2xl font-semibold lg:text-3xl text-left mb-10 italic relative after:absolute after:ml-[1rem] after:w-full after:h-[1px] after:bg-[#7d7789] after:left-25 after:top-1/2 after:-translate-y-1/2">
            Skills
          </p>
          <div className="max-w-7xl mx-2 flex flex-wrap flex-col">
              ...
              <div className="w-full flex flex-wrap mx-auto gap-2 lg:gap-3 mb-5">
                {FrontEnd.map((e, i) => {
                  return (
                    <p
                      key={i}
                      className=" font-medium border-[2px] dark:border-white border-gray-500 rounded-2xl p-2 text-sm text-md lg:text-lg"
                    >
                      {e.name}
                    </p>
                  );
            ...
            <div className="flex flex-col gap-2">
              <p className="font-semibold text-sm md:text-md lg:text-xl">
                📙Back-End
              </p>
              <div className="w-full flex flex-wrap mx-auto gap-2 lg:gap-3 mb-5">
                {BackEnd.map((e, i) => {
                ...
                <div className="w-full flex flex-wrap mx-auto gap-2 lg:gap-3 mb-5">
                  ...
                  <div className="flex flex-wrap p-[2rem] gap-9 w-full">
                    <div className="mx-auto basis-full md:basis-[45%] h-auto border-[2px] dark:border-white border-gray-500 rounded-[2rem] relative m-2">
                      <div className="absolute -left-10 -top-5 text-[1.1rem] md:text-[1.5rem] border-[0.2rem] border-[#7da8d0] bg-white dark:bg-slate-800 p-[0.5rem_1rem] lg:text-[2rem] font-medium ">
                        React
                      </div>
                      <div className="m-[3rem] text-gray-600  dark:text-white font-medium text-md  lg:text-lg">
                        ...
                        <div className="lg:leading-[2.5rem] relative z-10">
                          • 컴포넌트의 재사용성을 고려해 컴포넌트를 구현할 수
                          있습니다
                        </div>
                        <div className="lg:leading-[2.5rem] relative z-10">
                          • React Router와 같은 라이브러리를 사용하여 라우팅을
                          구현할 수 있습니다
                        </div>
                      </div>
                    </div>
                    <div className="mx-auto basis-full md:basis-[45%] h-auto border-[2px] border-gray-500 dark:border-white rounded-[2rem] relative m-2">
                      ...
                      <div className="m-[3rem] text-gray-600 dark:text-white font-medium text-md lg:text-lg">
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • 서버와의 데이터 통신을 위해 API 엔드포인트를
                          생성하거나 외부 API와의 통신을 구현할 수 있습니다
                        </div>
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • fetch나 axios 등의 라이브러리를 활용하여 데이터를
                          요청하고 응답을 처리할 수 있습니다
                        </div>
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • MYSQL과 연동하여 CRUD 기능을 구현하기 위해 RESTful
                          API를 설계할 수 있습니다
                        </div>
                      </div>
                    </div>
                    <div className="mx-auto basis-full md:basis-[45%] h-auto border-[2px] border-gray-500 dark:border-white rounded-[2rem] relative m-2">
                      ...
                      <div className="m-[3rem] text-gray-600 dark:text-white font-medium text-md lg:text-lg">
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • CSS 미디어 쿼리를 사용하여 반응형 웹 디자인을 구현할
                          수 있습니다.
                        </div>
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • CSS의 트랜지션과 애니메이션 속성을 사용하여 웹
                          페이지에 애니메이션 효과를 추가할 수 있습니다.
                        </div>
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • Semantic Web에 대한 이해를 바탕으로 상황에 따라
                    ...
                    <div className="mx-auto basis-full md:basis-[45%] h-auto border-[2px] border-gray-500 dark:border-white rounded-[2rem] relative m-2">
                      ...
                      <div className="m-[3rem] text-gray-600 dark:text-white font-medium text-md lg:text-lg">
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • JavaScript를 사용하여 서버와의 데이터 통신을 구현할
                          수 있습니다.
                        </div>
                        <div className="leading-[1.5rem] lg:leading-[2.5rem] relative z-10">
                          • 최신 JavaScript 기능인 ES6 이후의 문법과 기능을
                          활용할 수 있습니다.
                        </div>
                      </div>
                    </div>
